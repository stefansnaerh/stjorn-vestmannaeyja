...
export default function CustomSearchBox(props: UseSearchBoxProps) {
  ...
  return (
    <div className="relative self-start w-fill md:min-w-[50%] md:max-w-[50%] ">
      <svg
        className=" absolute m-auto top-0 left-16 bottom-0 text-greyDarker"
        width="20"
        height="20"
        viewBox="0 0 16 16"
        fill="none"
      ...
      <input
        className="text-black  pl-48 h-fluid-72 w-fill border-greyInput"
        ref={inputRef}
        autoComplete="off"
        autoCorrect="off"
        autoCapitalize="off"
