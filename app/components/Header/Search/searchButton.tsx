    ...
    <>
      ...
      {isSearchOpen ? (
        <Container className="fixed top-[80px] xs:top-[90px] xxxl:min-w-[2000px]  xxxl:m-auto xxxl:left-0 xxxl:right-0 bg-backgroundGrey left-0 max-h-[100vh] overflow-scroll min-h-[100vh] min-w-[100vw]">
          <button
            onClick={handleOpenSearch}
            className="bg-pureWhite hidden rounded-6 py-fluid-16 px-fluid-24 group hover:text-buttonBlue absolute top-32 right-container-88 text-bodyGrey font-body md:flex gap-6 transition-all duration-150 ease-in-out"
          >
            Loka leitarglugga
            <svg
              width="24"
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="text-bodyGrey group-hover:text-buttonBlue rotate-45 self-center transition-all duration-150 ease-in-out"
            >
              <path
