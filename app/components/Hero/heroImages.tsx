...
export default function HeroImages({
  ...
  const newImgUrl = `${content.hero_image}&auto=enhance`;
  return (
    <>
      <div className=" relative overflow-hidden ">
        <div className="absolute w-fill z-10 h-fill opacity-[77%]   bg-gradient-to-r from-[30%] from-pureBlack  to-transparent"></div>
        {slide === 0 ? (
      ...
      <div className="absolute z-20 flex left-container-56  top-[50%] translate-y-[-50%] w-[40%] max-w-[2000px] ">
