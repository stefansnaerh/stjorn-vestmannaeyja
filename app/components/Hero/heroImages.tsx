...
export default function HeroImages({
  ...
  return (
    <>
      <div className="relative flex flex-col gap-fluid-56 px-container-88 py-64">
        <div className="w-fill flex justify-between">
          <FadeIn className="py-fluid-40 ">
            <h1 className="font-body text-headlineColor text-h4 font-semiBold ">
        ...
        <div className="  max-h-[100vh]    max-w-[2000px] self-center   ">
          <div className="relative flex max-w-[2000px] ">
            <div className=" flex  gap-fluid-56  pb-fluid-48">
              <HeroSlideElements
                setSlide={setSlide}
                slide={slide}
                content={content}
              />
              <div className="sm:w-[80%] flex flex-col gap-fluid-32">
                <div className="flex gap-fluid-40">
                  <FadeIn
                    delay={0.2}
                    className="relative hidden md:flex self-end h-[50%] w-[50%] pb-[70%] md:pb-[35%] "
                  >
                    <PrismicNextImage
                  ...
                  <FadeIn
                    delay={0.2}
                    className="relative w-fill md:w-[50%] pb-[70%] md:pb-[35%] "
                  >
                    <PrismicNextImage
