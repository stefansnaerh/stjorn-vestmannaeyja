...
export default function RichText(props: RichTextProps) {
  ...
  return (
    ...
    [&_h2]:text-h2 [&_h2]:font-headline [&_h2]:font-semiBold  [&_h2]:pt-fluid-40 [&_h2]:pb-fluid-40 [&_h2]:text-headlineBlue
    [&_h3]:text-h5 [&_h3]:font-body  [&_h3]:font-semiBold   [&_h3]:pt-fluid-32   [&_h3]:w-fit [&_h3]:text-orange
    [&_h4]:font-headline [&_h4]:font-semiBold [&_h4]:text-h6 [&_h4]:text-headlineBlue [&_h4]:pb-fluid-20 [&_h4]:pt-fluid-16 
    ...
    [&_ul]:list-disc [&_li]:marker:text-headlineBlue [&_li]:text-navLinks [&_li]:text-bodyGrey [&_li]:py-4 [&_ul]:py-8 [&_ol]:list-inside [&_ul]:list-inside [&_ol]:list-decimal [&_li]:marker:text-navLinks "
        >
