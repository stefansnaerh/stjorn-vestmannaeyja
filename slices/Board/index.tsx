                ...
                >
                  ...
                  <FadeIn className="flex flex-col  gap-fluid-32 justify-start ">
                    ...
                    <div className="flex flex-col gap-fluid-12">
                      ...
                      <a
                        className="text-sm bg-greyPurple group text-purple py-fluid-8 px-fluid-16 rounded-32 w-fit whitespace-nowrap  flex gap-6 hover:text-buttonBlue transition-all duration-300 ease-in-out"
