  ...
  return (
    ...
    >
      <Container className="overflow-hidden flex flex-col ">
        <div className="md:w-[80%]  w-fit flex flex-col gap-fluid-40">
          <div className="">
    ...
    [&_a]:text-body  [&_a]:font-semiBold  [&_a]:text-buttonBlue [&_a]:hover:text-cyanideBlue [&_a]:transition-all [&_a]:duration-300 [&_a]:ease-in-out
