...
const ServicesOverview = ({ slice }: ServicesOverviewProps): JSX.Element => {
  ...
  return (
    <div className="flex justify-center">
      <div className="lg:pb-fluid-122 pt-fluid-40 smmd:pt-fluid-64 max-w-[2000px]  pb-64 px-container-88 self-center   ">
              ...
              return (
                ...
                >
                  <div className="flex flex-col gap-fluid-16">
                    ...
                    <FadeIn delay={0.2}>
                      <p className="text-[16px] text-bodyGrey  font-regular font-body ">
                        {item.paragraph}
                      </p>
                    </FadeIn>
                  </div>
